    ...
    <div id="about" className="h-100 p-10 md:p-20 bg-gradient-to-r from-blue-500 via-blue-700 to-blue-800 flex items-center flex-col">
      <div data-aos="fade-left" data-aos-easing="ease-in-out" className="bg-gray-200 overflow-hidden shadow-lg rounded sm:flex sm:flex-row md:max-h-96 md:max-w-3xl">
        ...
        <div className="sm:flex sm:flex-col sm:justify-center py-8 sm:py-6 px-6">
          <span className="inline-block text-center bg-yellow-300 bg-opacity-70 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#JavaScript</span>
          <span className="inline-block text-center bg-blue-400 bg-opacity-70 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#React</span>
          <span className="inline-block text-center bg-green-500 bg-opacity-70 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#Vue.js</span>
          <span className="inline-block text-center bg-purple-400 bg-opacity-70 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#WordPress</span>
        </div>
      </div>
    </div>
  );
